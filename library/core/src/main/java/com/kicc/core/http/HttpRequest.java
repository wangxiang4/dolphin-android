package com.kicc.core.http;

import com.kicc.core.BuildConfig;
import com.kicc.core.constant.SecurityConstant;
import com.kicc.core.http.interceptor.CacheInterceptor;
import com.kicc.core.http.interceptor.CoreInterceptor;
import com.kicc.core.util.HttpsUtil;
...
public class HttpRequest {
    ...
    private HttpRequest() {
        ...
        okHttpClient = new OkHttpClient.Builder()
                ...
                //.cache(new Cache(new File(PathUtils.getInternalAppCachePath(), "kicc_cache"), ClientConfig.CACHE_SIZE))
