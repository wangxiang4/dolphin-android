package com.kicc.core.amap.overlay;
	...
	public void drawDrivingRoute() {
        try {
            ...
            mPolylineOptions = new PolylineOptions().color(getDriveColor())
                    .setCustomTexture(BitmapDescriptorFactory.fromResource(R.drawable.kc_ic_custtexture_driving))
                    .width(getRouteWidth());
                    ...
                    if (latLonPoint != null) {
                        throughPointMarkerList.add(mAMap
                            .addMarker((new MarkerOptions())
                                ...
                                .icon(BitmapDescriptorFactory.fromResource(R.drawable.kc_ic_pathway))
                                .title("途径点")));
                    }
                }
            }
