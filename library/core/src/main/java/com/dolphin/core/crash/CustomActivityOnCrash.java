...
public final class CustomActivityOnCrash {
    ...
    private static final String EXTRA_CONFIG = "com.dolphin.core.crash.EXTRA_CONFIG";
    private static final String EXTRA_STACK_TRACE = "com.dolphin.core.crash.EXTRA_STACK_TRACE";
    private static final String EXTRA_ACTIVITY_LOG = "com.dolphin.core.crash.EXTRA_ACTIVITY_LOG";

    //General constants
    private static final String INTENT_ACTION_ERROR_ACTIVITY = "com.dolphin.core.crash.ERROR";
    private static final String INTENT_ACTION_RESTART_ACTIVITY = "com.dolphin.core.crash.RESTART";
    private static final String CAOC_HANDLER_PACKAGE_NAME = "com.dolphin.core.crash";
     ...
     * It will first get activities from the AndroidManifest with intent filter <action android:name="com.dolphin.core.crash.RESTART" />,
    ...
    /**
     * INTERNAL method used to get the first activity with an intent-filter <action android:name="com.dolphin.core.crash.RESTART" />,
     ...
     * It will first get activities from the AndroidManifest with intent filter <action android:name="com.dolphin.core.crash.ERROR" />,
    ...
    /**
     * INTERNAL method used to get the first activity with an intent-filter <action android:name="com.dolphin.core.crash.ERROR" />,
     * If there is no activity with that intent filter, this returns null.
     *
     * @param context A valid context. Must not be null.
     * @return A valid activity class, or null if no suitable one is found
